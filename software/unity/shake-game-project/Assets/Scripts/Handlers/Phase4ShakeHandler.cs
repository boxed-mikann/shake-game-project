...
/// ========================================
/// </summary>
public class Phase4ShakeHandler : MonoBehaviour, IShakeHandler
{
    ...
    public void HandleShake()
    {
        ...
        {
            Debug.LogWarning("[Phase4ShakeHandler] NoteManager instance not found!");
            return;
        }
        ...
        if (oldest == null)
        {
            if (GameConstants.DEBUG_MODE)
                Debug.Log("[Phase4ShakeHandler] No notes to destroy");
            return;
        }
        ...
        if (GameConstants.DEBUG_MODE)
            Debug.Log($"[Phase4ShakeHandler] Rest note hit! Penalty: {_scoreValue}, Freeze: {_freezeDuration}s");
    }
}