...
/// ========================================
/// </summary>
public class Phase2ShakeHandler : MonoBehaviour, IShakeHandler
{
    ...
    public void HandleShake()
    {
        ...
        {
            Debug.LogWarning("[Phase2ShakeHandler] NoteManager instance not found!");
            return;
        }
        ...
        if (oldest == null)
        {
            if (GameConstants.DEBUG_MODE)
                Debug.Log("[Phase2ShakeHandler] No notes to destroy");
            return;
        }
        ...
        if (GameConstants.DEBUG_MODE)
            Debug.Log($"[Phase2ShakeHandler] Rest note hit! Penalty: {_scoreValue}, Freeze: {_freezeDuration}s");
    }
}